...
const PRODUTOS = [
  /* ---- Bloco 1 — Destaque Solutudo (página) ---- */
  {
    ...
    itens: [
      it({ texto: "Botões de contato (WhatsApp com número + telefone)", etapa: "experiencia", pilar: "verdade", impacto: "medio", sem: true, com: true }),
      it({ texto: "Endereço, mapa e coordenadas", etapa: "avaliacao", pilar: "verdade", impacto: "medio", sem: true, com: true }),
      ...
      it({ texto: "Horário completo", etapa: "avaliacao", pilar: "verdade", impacto: "baixo", sem: true, com: true }),
  ...
  /* ---- Bloco 2 — Solusite (site próprio) ---- */
  {
    ...
    itens: [
      ...
      it({ texto: "Horário e mapa", etapa: "avaliacao", pilar: "verdade", impacto: "baixo", sem: false, com: true }),
      it({ texto: "Formulário de contato + WhatsApp", etapa: "experiencia", pilar: "verdade", impacto: "medio", sem: false, com: true }),
  ...
  /* ---- Bloco 3 — Google Meu Negócio (GMB) ---- */
  {
    ...
    itens: [
      ...
      it({ texto: "Categoria primária + secundárias corretas", etapa: "descoberta", pilar: "verdade", impacto: "alto", sem: false, com: true }),
      it({ texto: "NAP idêntico (nome/endereço/telefone) aos outros produtos", etapa: "avaliacao", pilar: "verdade", impacto: "alto", critico: true, sem: false, com: false, dono: "nos", acao: "Conferir e alinhar nome, endereço e telefone com Solutudo, site e redes." }),
      it({ texto: "Horário (inclui feriados / exceções)", etapa: "avaliacao", pilar: "verdade", impacto: "baixo", sem: true, com: true }),
  ...
  /* ---- Bloco 4 — Redes Sociais (Instagram/Facebook) ---- */
  {
    ...
    cor: "var(--brand-cyan)",
    itens: [
      it({ texto: "Bio completa (o que faz, cidade, contato)", etapa: "descoberta", pilar: "verdade", impacto: "medio", sem: true, com: true }),
      ...
      it({ texto: "Identidade visual consistente (logo, paleta, tipografia)", etapa: "avaliacao", pilar: "verdade", impacto: "medio", sem: false, com: true }),
  ...
  /* ---- Bloco 6 — Consistência (informação + visual) ---- */
  {
    ...
    preview: false,
    itens: [
      it({ texto: "Nome da empresa EXATAMENTE igual em todos os produtos", etapa: "descoberta", pilar: "verdade", impacto: "alto", critico: true, sem: false, com: true }),
      it({ texto: "Endereço idêntico (atenção ao número)", etapa: "descoberta", pilar: "verdade", impacto: "alto", critico: true, sem: false, com: false, dono: "nos", acao: "Número diverge entre canais (ex.: \u201C230\u201D no Instagram × \u201C240\u201D no site) — padronizar." }),
      it({ texto: "Telefone / WhatsApp iguais em todos", etapa: "descoberta", pilar: "verdade", impacto: "alto", sem: false, com: true }),
      it({ texto: "Horário igual em todos", etapa: "avaliacao", pilar: "verdade", impacto: "medio", sem: false, com: true }),
      it({ texto: "Categoria / segmento alinhada", etapa: "descoberta", pilar: "verdade", impacto: "medio", sem: false, com: true }),
      ...
      it({ texto: "Logo igual em todos os canais", etapa: "avaliacao", pilar: "verdade", impacto: "medio", sem: true, com: true }),
